...
const benefits = [
  {
    ...
    text: 'Товары и услуги, которые могли остаться непроданными, превращаются в деньги. Вечерняя выпечка, свободные окна записи, сезонные позиции — всё работает на кассу.',
    featured: true,
  },
  {
    Icon: IconUsers,
...
const faq = [
  ...
  },
  {
    ...
    a: 'Нет. Вы предлагаете ограниченное количество позиций в конкретные часы — например, к закрытию. Это инструмент управления остатками, а не постоянная скидка.',
  },
  {
...
export default function PartnersPage() {
  return (
    <Layout title="Партнёрам" description="Станьте партнёром GrabYou: превращайте остатки и свободные часы в выручку и новых клиентов">
        ...
        <div className="container">
          ...
          <section className={styles.section}>
            ...
            <p className={styles.catNote}>
              Выпечка к закрытию, нераспроданные букеты, свободные окна записи,
