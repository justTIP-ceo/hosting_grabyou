...
/* Булавки: x/y — проценты по viewBox карты, привязаны к реальным районам */
const mapPins = [
  {x: 56, y: 35, tone: 'urgent', title: 'Пекарня на Литейном', deal: '−45%', meta: 'круассаны · 350 м'},
  {x: 63, y: 51, tone: 'lime', title: 'Кофейня у Восстания', deal: '−30%', meta: 'до 21:00 · 600 м'},
  {x: 26, y: 44, tone: 'green', title: 'Цветы на Васильевском', deal: '−40%', meta: 'букет дня · 1,2 км'},
  {x: 44, y: 68, tone: 'route', title: 'Кафе у Обводного', deal: '−35%', meta: 'бизнес-ланч · 900 м'},
];
