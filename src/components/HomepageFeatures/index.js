...
/* Булавки: x/y — проценты по viewBox карты.
   Места выбраны по маске воды и улиц, чтобы точка не садилась на реку. */
const mapPins = [
  {x: 38, y: 22, tone: 'urgent', title: 'Пекарня на Литейном', deal: '−45%', meta: 'круассаны · 350 м'},
  {x: 68, y: 40, tone: 'lime', title: 'Кофейня у Восстания', deal: '−30%', meta: 'до 21:00 · 600 м'},
  {x: 17, y: 56, tone: 'green', title: 'Цветы на Васильевском', deal: '−40%', meta: 'букет дня · 1,2 км'},
  {x: 57, y: 84, tone: 'route', title: 'Кафе у Обводного', deal: '−35%', meta: 'бизнес-ланч · 900 м'},
];
